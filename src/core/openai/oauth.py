...
def _sha256_b64url_no_pad(s: str) -> str:
    """Base64 URL encoding after SHA256 hashing"""
...
def _post_form(
    ...
    try:
        # Use curl_cffi to send requests, support proxy and browser fingerprinting
...
def submit_callback_url(
    *,
    ...
    Raises:
        ...
        ValueError: Required parameters are missing or state does not match
    """
